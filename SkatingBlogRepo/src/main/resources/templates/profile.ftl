        ...
        <div class="row m-2">
            <div class="col p-5 m-5 text-wrap special_col" style="font-size:x-large; text-align: center;" >
                ...
                <div class="d-flex justify-content-center mt-3 ">
                    <button type="button" class="btn btn-block btn-lg text-body special round" onClick='location.href=""'>Записаться</button>
                </div>
            </div>
            <div class="col p-5 m-5 text-wrap special_col" style="font-size: x-large; text-align: center;">
                Познакомьтесь с нашей дружной командой тренеров
                <div class="d-flex justify-content-center mt-5">
                    <button type="button" class="btn btn-block btn-lg text-body special round" onClick='location.href=""'>Тренеры</button>
                </div>
            </div>
            <div class="col p-5 m-5 text-wrap special_col" style="font-size: x-large; text-align: center;">
                Изучайте элементы фигурного катания онлайн
                <div class="d-flex justify-content-center mt-5">
                    <button type="button" class="btn btn-block btn-lg text-body special round" onClick='location.href=""'>Видеокурс</button>
                </div>
            </div>
        </div>
    </section>
